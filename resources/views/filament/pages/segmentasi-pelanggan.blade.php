    ...
    @if (empty($pelanggan))
        <div class="bg-yellow-50 dark:bg-yellow-900 border border-yellow-300 rounded-xl p-6 text-center">
            <p class="text-yellow-700 dark:text-yellow-200 font-medium">
                ⚠️ Data belum cukup. Butuh minimal 3 pelanggan dengan status
                <strong>lunas</strong> untuk menjalankan K-Means.
            </p>
        </div>
    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 mb-6">
            <h2 class="text-base font-semibold text-gray-700 dark:text-gray-200 mb-1">
                Scatter Plot: Recency vs Total Belanja
            </h2>

            <p class="text-xs text-gray-400 mb-4">
                Setiap titik mewakili satu pelanggan. Warna menunjukkan segmen pelanggan hasil clustering K-Means.
            </p>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 uppercase text-xs">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-center">Recency</th>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (!canvas) {
                    console.error('Canvas scatterChart tidak ditemukan');
                    return;
                }
