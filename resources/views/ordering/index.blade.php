        ...
        <div class="logo-wrap">
            ...
            <div class="logo-icon">
                ...
                <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M22 16 Q24 10 26 16 Q28 10 30 16"
                          stroke="#fff"
                          stroke-width="2"
                          fill="none"
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <p class="card-subtitle">
                Isi informasi berikut sebelum mulai memesan menu favoritmu.
            </p>
        ...
        {{-- Footer --}}
        <p class="footer">
            © {{ date('Y') }} Kreato Coffee. All rights reserved.
        </p>
